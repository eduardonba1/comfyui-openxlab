...
os.system(f"aria2c --console-log-level=error -c -x 16 -s 16 -k 1M URL_FOR_SDXL_BASE_SAFETENSORS -d /home/xlab-app-center/ComfyUI/models/checkpoints -o sd_xl_base_0.9.safetensors")
os.system(f"aria2c --console-log-level=error -c -x 16 -s 16 -k 1M URL_FOR_SDXL_REFINER_SAFETENSORS -d /home/xlab-app-center/ComfyUI/models/checkpoints -o sd_xl_refiner_0.9.safetensors")
